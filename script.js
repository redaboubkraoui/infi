...
jQInf(jQInf(paginateSelector).get(0)).after('<div style="width: 100%;" id="clevercollectionbottom"><center> <button id="cleverload" style="border-width: 1px; border-radius: 0; font-size: 14px; border-color: #fcffff; background-color: #f8d8d7; color: #000000; font-family:roboto; margin-bottom: 24px; width: 12%; height: 40px; cursor: pointer; font-weight: BOLD; border: 0px solid #fcffff;" type="button">' + loadMoreBtnText + '</button> <img id="cleverloaderimg" style="margin-top: 10px; display: none; width=30px;" src="https://odapps.net/img/loader.gif"> </center></div>');
}
}
else {
if(loaderMode == 1) {
